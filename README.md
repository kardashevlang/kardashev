...
kardashev is **pre-1.0**. Every numbered roadmap — **v1 through v100** — has shipped, released as **v0.1.0 through v0.100.0**, each green on a cleared clean build (6 unit suites plus the full smoke / fuzz aggregate, **JIT and AOT**) on **Linux + macOS** CI. The per-version detail lives in **[CHANGELOG.md](CHANGELOG.md)**; the current release is **[v0.100.0](https://github.com/kardashevlang/kardashev/releases/latest)**.
